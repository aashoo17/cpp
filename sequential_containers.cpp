...
they are called sequential as elements kept in same order as you start pushing them to this container
say first 10,20,40 then 30 i have putted
i will get back in same order first 10,20,40 then 30
...
following operations are required generally on sequential containers and we will work on it
...
that means if we get iterator it does not matter if it is vector, deque, list....or other seq containers
so any algorithm can be applied on these containers by getting iterator on them
...
void vector_(){
    //create
    //for other way of creation see the vector.cpp file - same will work on other sequential type also
    vector<int> a{10,20,30,40,50};  //list initaializer will be the most common ways of initializing it
...
//deque
//vector vs deque
//deque can grow in back and front both side but vector can grow only in the back
//this means deque keep extra memory in front and back both sides
void deque_(){
    //create
    //for other way of creation see the vector.cpp file - same will work on other sequential type also
    deque<int> a{10,20,30,40,50};  //list initaializer will be the most common ways of initializing it
...
void list_(){
    //create
    //for other way of creation see the vector.cpp file - same will work on other sequential type also
    list<int> a{10,20,30,40,50};  //list initaializer will be the most common ways of initializing it
